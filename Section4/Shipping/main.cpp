/* 
    ...
    Base cort $2.50
    If package volume is greater than 100 cubic inches there is a 10% surcarge
    If package vloume is greater than 500 cubic inches there is a 25% surcharge
...
int main() {
    ...
    // All dimensaion must be 10 inches or less
