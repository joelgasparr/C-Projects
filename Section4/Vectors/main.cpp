...
int main () {
    ...
    cout << "\nThe scores using arrays syntax:" << endl;
    ...
    cout << test_scores[2] << endl;
     ...
     cout << "\nThe scores using vector syntax:" << endl;
    ...
    cout << "\nEnter one more test score to add the vector: ";
   ...
   // cout << "This should cause an excepcion!!"<< test_scores.at(10) << endl;
